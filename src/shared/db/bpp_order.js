...
const BppOrderSchema = new mongoose.Schema(
    {
        context:{type:Object},
        ...
        id: { type: String },
        city: { type: String },
        state: { type: String }, //['Created', 'Accepted', 'In-progress', 'Completed', 'Cancelled', 'Packed', 'Out-for-delivery']
        userId: String,
        ...
        seller_pincode: { type: String, default:"500070" },
        sku_name: { type: String, default:null },
        sku_code: { type: String, default:null },
        order_category: { type: String, default:"F&B" },
...
BppOrderSchema.index({ userId: 1, createdAt: -1 });
BppOrderSchema.plugin(mongoosePaginate)
const BppOrder = mongoose.model('bpp_order', BppOrderSchema, "bpp_order");

export default BppOrder;