...
class BppUpdateService {
     ...
     * @returns 
     */
    async updateLspOrder(context, updateOrderRequest) {
        try {
            ...
            let topic = topics.CLIENT_API_LSP_BAP_UPDATE

            await produceKafkaEvent(kafkaClusters.LSP,topic, updateRequest)
