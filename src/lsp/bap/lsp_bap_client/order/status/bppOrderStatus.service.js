...
class BppOrderStatusService {
     ...
     * @returns 
     */
     async getLspOrderStatus(context, messagePayload = {}) {
        try {
            ...
            let topic = topics.CLIENT_API_LSP_BAP_STATUS

            await produceKafkaEvent(kafkaClusters.LSP,topic, orderStatusRequest)
