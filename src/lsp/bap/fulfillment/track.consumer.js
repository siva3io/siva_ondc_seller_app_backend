...
const lspBapTrackConsumer = async (consumerConfig) => {
    ...
    await consumer.run({
        ...
        eachMessage: async ({ topic, partition, message }) => {
            ...
            let topic_ack = topics.CLIENT_API_LSP_BAP_TRACK_ACK

            service.ONDCTrackLspOrderEvent(request).then(response => {
...
const lspBapTrackAckConsumer = async (consumerConfig) => {
...
const lspBapBppTrackConsumer = async (consumerConfig) => {
    ...
    await consumer.run({
        ...
        eachMessage: async ({ topic, partition, message }) => {
            ...
            let topic_ack = topics.LSP_BAP_BPP_TRACK_ACK
...
const lspBapBppTrackAckConsumer = async (consumerConfig) => {
...
export {
    lspBapTrackConsumer,
    lspBapTrackAckConsumer,
    lspBapBppTrackConsumer,
    lspBapBppTrackAckConsumer
}