...
const lspBapInitConsumer = async (consumerConfig) => {
    ...
    await consumer.run({
        ...
        eachMessage: async ({ topic, partition, message }) => {
            ...
            let topic_ack = topics.CLIENT_API_LSP_BAP_INIT_ACK

            service.ONDCLspInitOrderEvent(request).then(response => {
...
const lspBapInitAckConsumer = async (consumerConfig) => {
...
const lspBapBppInitConsumer = async (consumerConfig) => {
    ...
    await consumer.run({
        ...
        eachMessage: async ({ topic, partition, message }) => {
            ...
            let topic_ack = topics.LSP_BAP_BPP_INIT_ACK
...
const lspBapBppInitAckConsumer = async (consumerConfig) => {
...
export {
    lspBapInitConsumer,
    lspBapInitAckConsumer,
    lspBapBppInitConsumer,
    lspBapBppInitAckConsumer
}