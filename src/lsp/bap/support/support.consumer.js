...
const lspBapSupportConsumer = async (consumerConfig) => {
    ...
    await consumer.run({
        ...
        //     }) 
            ...
            let topic_ack = topics.CLIENT_API_LSP_BAP_SUPPORT_ACK

            service.ONDCSupportLspOrderEvent(request).then(response => {
...
const lspBapSupportAckConsumer = async (consumerConfig) => {
...
const lspBapBppSupportConsumer = async (consumerConfig) => {
    ...
    await consumer.run({
        ...
        eachMessage: async ({ topic, partition, message }) => {
            ...
            let topic_ack = topics.LSP_BAP_BPP_SUPPORT_ACK
...
const lspBapBppSupportAckConsumer = async (consumerConfig) => {
...
export {
    ...
    lspBapSupportConsumer,
    lspBapSupportAckConsumer,
    lspBapBppSupportConsumer,
    lspBapBppSupportAckConsumer
}